...
//ol.proj.get("EPSG:3857").setExtent([7725589.295644, 3737770.316189, 8496964.625623, 4422831.563308]);
var wms_layers = [];
...
var format_AllTDPP_6 = new ol.format.GeoJSON();
var features_AllTDPP_6 = format_AllTDPP_6.readFeatures(json_AllTDPP_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AllTDPP_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AllTDPP_6.addFeatures(features_AllTDPP_6);
var lyr_AllTDPP_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AllTDPP_6, 
                style: style_AllTDPP_6,
                popuplayertitle: 'All TD PP',
                interactive: true,
                title: '<img src="styles/legend/AllTDPP_6.png" /> All TD PP'
            });
...
lyr_ESRITopo_0.setVisible(true);lyr_OpenTopoMap_1.setVisible(true);lyr_MapzenGlobalTerrain_2.setVisible(true);lyr_AllTDwatershedexostreams_3.setVisible(true);lyr_AllTDwatershedendostreams_4.setVisible(true);lyr_AllTDreaches_5.setVisible(true);lyr_AllTDPP_6.setVisible(true);lyr_AllTDupstreampts_7.setVisible(true);lyr_AllTDdownstreampts_8.setVisible(true);
var layersList = [lyr_ESRITopo_0,lyr_OpenTopoMap_1,lyr_MapzenGlobalTerrain_2,lyr_AllTDwatershedexostreams_3,lyr_AllTDwatershedendostreams_4,lyr_AllTDreaches_5,lyr_AllTDPP_6,lyr_AllTDupstreampts_7,lyr_AllTDdownstreampts_8];
...
lyr_AllTDPP_6.set('fieldLabels', {'NAME': 'no label', 'LAYER': 'no label', 'MAP_NAME': 'no label', 'DATABASE_I': 'no label', 'STREAM_IND': 'no label', 'TD_WATERSH': 'no label', 'TD_STREAM': 'no label', 'GLACIAL': 'no label', 'MAIN_BAS': 'no label', 'MAIN_BAS_N': 'no label', 'AE_ELEV_DE': 'no label', 'ME_ELEV_DE': 'no label', 'AVG_SLOPE_': 'no label', 'AE_ELEV_MA': 'no label', 'TD_INDEX_N': 'no label', 'PP': 'no label', 'PP_RELAT': 'no label', 'VISUAL': 'no label', 'TECTO_FEAT': 'no label', 'TECTO_GROU': 'no label', 'GENERAL_LI': 'no label', 'Lithology': 'no label', 'COMB_STR_S': 'no label', 'COMB_STR_1': 'no label', 'DIS_M3_PYR': 'no label', 'AVG_ELEV_M': 'no label', 'CONTINENT': 'no label', 'DEM': 'no label', 'ELEVATION': 'no label', 'ENDORHEIC': 'no label', 'MAIN_RIV': 'no label', 'MAIN_RIV_N': 'no label', 'X': 'no label', 'Y': 'no label', 'KML_FOLDER': 'no label', 'POINT_SYMB': 'no label', 'FONT_NAME': 'no label', 'FONT_SIZE': 'no label', 'FONT_COLOR': 'no label', 'FONT_CHARS': 'no label', 'FONT_WEIGH': 'no label', });
